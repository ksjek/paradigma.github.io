(() => {
    ...
    window.addEventListener("load", (function(e) {
        ...
        const check = document.querySelector(".form-popup__icon");
        const btn = document.querySelector(".button-call");
        btn.disabled = true;
        check.addEventListener("click", (function() {
            check.classList.toggle("_active-icon");
            check.classList.contains("_active-icon");
            if (true === check.classList.contains("_active-icon")) btn.disabled = false;
        }));
    }));
    window["FLS"] = true;
    isWebp();
